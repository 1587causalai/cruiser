...
<img src="https://i.loli.net/2018/02/26/5a93a0e25fcd9.png" alt="1.png" title="1.png" />


每个模块包含视频，slides和其他相关资料。例如正则表达式模块如下：

<img src="https://i.loli.net/2018/02/26/5a93a0e2693ab.png" alt="2.png" title="2.png" />

> 2, 理论和代码紧密结合的在线教材

教材的每个章节，分别对应每个知识讲解模块。 教材地址：https://www.py4e.com/html3/

<img src="https://i.loli.net/2018/02/26/5a93a0e26dd65.png" alt="3.png" title="3.png" />
...
<img src="https://i.loli.net/2018/02/26/5a93a0e27997d.png" alt="4.png" title="4.png" />
...
每个人都有其不同的，最适合的，掌握基础python 编程的途径，可能对于某些人来说，PY4E 并没有什么效果，尽管 PY4E 有这些可能的不足之处。重点是：它的作为一个精心制作的，系统化的基础 python 编程训练体系值得推荐！

更多 about PY4E 和基础 python 编程参考知乎： https://www.zhihu.com/question/36254617  
网页版本查看此文。http://rpubs.com/Heyang_Gong/PY4E
